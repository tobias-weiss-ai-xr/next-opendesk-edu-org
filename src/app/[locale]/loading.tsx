...
export default function Loading() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-gradient-to-br from-accent/10 to-accent/5 py-16">
        <div className="max-w-6xl mx-auto px-4">
          <div className="animate-pulse">
            <div className="h-8 bg-foreground/10 rounded w-64 mb-4"></div>
            <div className="h-12 bg-foreground/10 rounded w-96 mb-6"></div>
            <div className="h-6 bg-foreground/10 rounded w-80"></div>
          </div>
        </div>
      </div>
