...
export default async function AboutPage() {
  ...
  const PROJECTS = [
    {
      title: tHeader("components"),
      description: t("projectComponents"),
      href: "/components" as const,
    },
  ...
  return (
    <main className="max-w-6xl mx-auto px-6 py-16">
      <div className="mb-16">
        ...
        <p className="text-lg text-foreground-secondary max-w-2xl">{t("description")}</p>
      </div>
      ...
      <section className="rounded-lg border border-border bg-background-secondary p-8 text-center">
        ...
        <p className="text-foreground-secondary mb-4">{t("contactDescription")}</p>
